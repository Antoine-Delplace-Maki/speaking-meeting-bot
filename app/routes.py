...
def _build_image_prompt(persona: dict) -> str:
    ...
    if persona.get("is_randomized_candidate"):
        ...
        clothing = _rng.choice([
            ...
            "a simple long-sleeve henley",
            "a quarter-zip pullover",
            "a plain Oxford shirt",
            "a simple round-neck sweater",
            "a flannel shirt",
        ])
        hair = _rng.choice([
            ...
            "straight hair pulled back in a simple ponytail",
            "short curly hair",
            "medium-length wavy hair",
            "a simple low bun",
            "short natural hair",
            "straight hair tucked behind the ears",
            "medium-length hair with a middle part",
            "short tapered hair",
